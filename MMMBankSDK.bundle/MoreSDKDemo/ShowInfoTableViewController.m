...
-(void)postData:(id)sender {
    ...
    UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"test" message:@"进入乾多多插件页面" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"前往", nil];
    alertView.tag = 1001;
    [alertView show];
...
//    
//    
////    [ControllerActivity setServiceURL:@"https://register.moneymoremore.com"];
//    
//    
//    [ControllerActivity setPresentViewController:self];
//    
...
//              }
//     ];
//    [ControllerActivity clearPresentViewController];
